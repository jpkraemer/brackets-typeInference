...
define(function (require, exports, module) {
		...
		"currentFullEditor": {
			...
			set: function (newFullEditor) { 
				if (newFullEditor !== this._currentFullEditor) {
					if ((this.isAutomaticSuiteSelectionEnabled) && (this._currentFullEditor !== undefined)) {
		...
		"testSuite": {
			get: function () {
				if ((this._collectionSelector.value === "autogenerated") && (this._suiteSelector.value === "auto")) {
					return this.testCaseCollection.getTestSuiteForTitle(this.functionIdentifier, true);
				} else {
					return this.testCaseCollection.getTestSuiteForTitle(this._suiteSelector.value, true);
				}
			},
	...
	TestCasesPane.prototype._onCollectionSelectorChange = function() {
		if (this._collectionSelector.value !== undefined) {
